...
ActiveRecord::Schema[7.0].define(version: 2022_11_27_162332) do
  ...
  create_table "checkout_cards", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
