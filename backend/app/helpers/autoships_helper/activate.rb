module AutoshipsHelper::Activate
  def activate(customer:, public_id:, recurring_interval:, recurring_interval_count:, next_shipment_on:)
    ...
    raise(RuntimeError, 3007007) unless next_shipment_on > Utils.utc_to_local_time(country: customer.country)
